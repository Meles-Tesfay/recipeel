    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4"
      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-[28px] font-bold text-zinc-900 tracking-tight">Welcome back</h1>
          <p className="text-[15px] mt-1.5 text-zinc-500">Sign in to your account</p>
        </div>
        ...
        <div className="bg-white rounded-[24px] shadow-sm border border-zinc-200/80 p-6 sm:p-8 space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <Link href="/forgot-password" className="text-[13px] font-semibold hover:underline" style={{ color: "var(--brand-green)" }}>
                Forgot password?
              </Link>
            </div>
            <div className="relative">
